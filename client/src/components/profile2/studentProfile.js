      ...
      <div className="container">
          <div>
            <div className="panel-heading lead">
                <div className="row">
                    <div className="col-lg-8 col-md-8"><i className="fa fa-users"></i> View Student Details</div>
                </div>
            </div>
            <br/>
                    ...
                    <div className="col-lg-3 col-md-3">
                      <center>
                        <span className="text-left">
                          <img src={profile} className="img-responsive img-thumbnail"/>
                          ...
                          <div className="table-responsive panel">
                            <table className="table">
                              <tbody>
                                ...
                                <tr>
                                    <td className="text-success"><i className="fa fa-group"></i> Class &amp;Type</td>
                                    <td>PG</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="text-success"><i className="fa fa-university"></i> Year of enrollment</td>
                                  <td>2014</td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <table className="table">
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <address>
                                      <strong>C-***, Amahiya </strong><br/>Kharobar, ****** <br/>Gorakhpur, Utter Pradesh, India<br/>
                                    </address>
                                  </td>
                                </tr>
                              </tbody>
